---
title: "prettified-Week2Markdown"
author: "Ritika"
date: "`r Sys.Date()`"
...
This is Ritika Sibal's R Markdown File for Modules 3,4 & 5. Both work and notes have been seperated by modules where relevant
...
You will also need to install *install.packages("httpuv")* for dropbox section incase you see a bad request popup
